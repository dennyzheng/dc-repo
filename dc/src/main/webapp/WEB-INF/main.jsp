    ...
    <div data-options="region:'west',title:'导航菜单',split:true" style="width:180px;">
        <div id="aa" class="easyui-accordion" data-options="fit:true" style="width:300px;height:200px;">
            ...
            <div title="系统管理" data-options="iconCls:'icon-reload'" style="padding:10px;">
                <a id="btn11" href="#" onclick="show('用户管理','${baseURL}/base/goURL/system/sys-user.mvc');" class="easyui-linkbutton" data-options="iconCls:'icon-search'">用户管理</a>
                <a id="btn12" href="#" onclick="show('角色管理','${baseURL}/base/goURL/system/sys-role.mvc');" class="easyui-linkbutton" data-options="iconCls:'icon-search'">角色管理</a>
